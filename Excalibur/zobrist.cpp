...
// Accessed as constants in movegen. Will be filled up by Zobrist::init_keys_psqt()
...
namespace Zobrist
{
	...
	/// init_keys_psqt() initializes at startup the various arrays used to compute hash keys
